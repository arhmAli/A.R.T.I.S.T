...
if __name__ == '__main__':
    try:
        ...
        # Navigate to a few goals
        nav_slam.navigate_to_goal(1.0, 1.0, 0.0)
        nav_slam.navigate_to_goal(-1.0, -1.0, 1.57)
        ...
        nav_slam.navigate_to_goal(2.0, 2.0, 0.0)
        nav_slam.navigate_to_goal(-2.0, -2.0, 1.57)
